 ...
 *
 * Generated from pycountry (the ISO register) and libphonenumber, the same
 * two sources the backend validates against — so the dropdown cannot offer
 * something PATCH /api/tenant would then reject.
 *
 * A constant rather than an endpoint on purpose. This list changes roughly
 * once a decade, and a network round-trip before the form can render buys
 * nothing over ~12KB in the bundle. Tenant-SPECIFIC data is the opposite
 * case: which countries an agency covers comes from user_countries and
 * belongs behind an API.
 *
 * Regenerate with the snippet in db/SCHEMA.md if the register changes.
 */
export interface Country {
  /** ISO 3166-1 alpha-2, what `tenants.country` stores. */
  code: string;
  name: string;
...
export const COUNTRIES: Country[] = [
  ...
  { code: "CD", name: "Congo, The Democratic Republic of the", dial: "243", flag: "🇨🇩" },
  ...
  { code: "FK", name: "Falkland Islands (Malvinas)", dial: "500", flag: "🇫🇰" },
  ...
  { code: "VA", name: "Holy See (Vatican City State)", dial: "39", flag: "🇻🇦" },
  ...
  { code: "FM", name: "Micronesia, Federated States of", dial: "691", flag: "🇫🇲" },
  ...
  { code: "PS", name: "Palestine, State of", dial: "970", flag: "🇵🇸" },
  ...
  { code: "SX", name: "Sint Maarten (Dutch part)", dial: "1", flag: "🇸🇽" },
  ...
  { code: "VG", name: "Virgin Islands, British", dial: "1", flag: "🇻🇬" },
  { code: "VI", name: "Virgin Islands, U.S.", dial: "1", flag: "🇻🇮" },
